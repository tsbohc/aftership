...
3. Используйте плейт-вилку (линейку или любой другой пластиковый/деревянный шим толщиной 1.6-1.9мм), чтобы удержать плейт на месте и сделать процесс проще.
    <details>
