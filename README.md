...
`Any` из вкладки *Special* позволяет вручную назначить на клавишу любой keycode, поддерживаемый QMK. Например, `LCTL(KC_Z)` назначит сочетание `ctrl+z` на выделенную клавишу. С подробным списком можно ознакомиться в документации QMK: [https://docs.qmk.fm/#/keycodes](https://docs.qmk.fm/#/keycodes).
